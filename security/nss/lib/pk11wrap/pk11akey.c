...
#define NUM_RESERVED_ATTRS 5 /* number of reserved attributes above */
     ...
     * per-RFC5915 */
    if (privKey->keyType != ecKey && privKey->keyType != edKey && privKey->keyType != ecMontKey && privKey->keyType != mldsaKey) {
                                ...
                                CK_FLAGS opFlags, CK_FLAGS opFlagsMask, void *wincx)
{
    ...
    CK_ATTRIBUTE mlDsa65PubTemplate[] = {
        { CKA_TOKEN, NULL, 0 },
        { CKA_DERIVE, NULL, 0 },
        { CKA_WRAP, NULL, 0 },
        { CKA_VERIFY, NULL, 0 },
    ...
    switch (type) {
        ...
        case CKM_EC_EDWARDS_KEY_PAIR_GEN:
            ...
            break;
        case CKM_ML_DSA_KEYGEN:
            attrs = mlDsa65PubTemplate;
            attrs++;
            pubTemplate = mlDsa65PubTemplate;
            keyType = mldsaKey;
